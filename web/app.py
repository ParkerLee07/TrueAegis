...
TARGETS_DIR = Path.home() / "netsniper" / "targets"
...
def latest_scan():
    path = latest_file(TARGETS_DIR, "analysis_*.json")
...
def findings():
    ...
    return render_template("findings.html", scan_path=scan_path, findings=rows)
